...
public class Player extends Entity {
    ...
    /**
     * stores the maximum possible energy for this player
     */
    private final int maxEnergy;

    /**
     * stores the current energy for this player
     */
    private int energy;
     ...
     *
     * @return the value of the energy attribute for the player object
     */
